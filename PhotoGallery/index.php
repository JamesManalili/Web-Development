		  ...
		  <div class="row">
				...
				<div class="modal fade" id="m1">
					<div class="modal-dialog">
						 <div class="modal-content">
							<div class="modal-header">Bigbike 1</div>
							<div class="modal-body">
							   <img src="pics/1.jpg" class = "img-thumbnail">
							</div>
							<div class="modal-footer">My Bigbike 1</div>
						</div>
					</div>
				</div>			
			</div>
			...
			<div class="col-md-4">
				...
				<div class="modal fade" id="m2">
					<div class="modal-dialog">
						 <div class="modal-content">
							<div class="modal-header">Bigbike 2</div>
							<div class="modal-body">
							   <img src="pics/2.jpg" class = "img-thumbnail">
							</div>
							<div class="modal-footer">My Bigbike 2</div>
						</div>
					</div>
				</div>	
			</div>
			...
			<div class="col-md-4">
				...
				<div class="modal fade" id="m3">
					<div class="modal-dialog">
						 <div class="modal-content">
							<div class="modal-header">Bigbike 3</div>
							<div class="modal-body">
							   <img src="pics/3.jpg" class = "img-thumbnail">
							</div>
							<div class="modal-footer">My Bigbike 3</div>
						</div>
					</div>
				</div>	
			</div>
			...
			<div class="col-md-4">
				...
				<div class="modal fade" id="m4">
					<div class="modal-dialog">
						 <div class="modal-content">
							<div class="modal-header">Bigbike 4</div>
							<div class="modal-body">
							   <img src="pics/4.jpg" class = "img-thumbnail">
							</div>
							<div class="modal-footer">My Bigbike 4</div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-md-4">
				...
				<div class="modal fade" id="m5">
					<div class="modal-dialog">
						 <div class="modal-content">
							<div class="modal-header">Bigbike 5</div>
							<div class="modal-body">
							   <img src="pics/3.jpg" class = "img-thumbnail">
							</div>
							<div class="modal-footer">My Bigbike 5</div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-md-4">
				...
				<div class="modal fade" id="m6">
					<div class="modal-dialog">
						 <div class="modal-content">
							<div class="modal-header">Bigbike 6</div>
							<div class="modal-body">
							   <img src="pics/3.jpg" class = "img-thumbnail">
							</div>
							<div class="modal-footer">My Bigbike 6</div>
						</div>
					</div>
				</div>
			</div>

            ...
            <div class = "carousel slide" data-ride = "carousel" id = "c1">
                ...
                <div class = "carousel-inner">
                    <div class = "item active">
                        <img src="pics/1.jpg" style ="width:800px;height:509px;">
                        <div class = "carousel-caption">
                           <h4>My Pic 1</h4>
                           <p> My Sports bike 1</p>
                        </div>
                    </div>

                    <div class = "item">
                        <img src="pics/2.jpg" style ="width:800px;height:509px;">
                        <div class = "carousel-caption">
                           <h4>My Pic 2</h4>
                           <p> My Sports bike 2</p>
                        </div>
                    </div>

                    <div class = "item">
                        <img src="pics/3.jpg" style ="width:800px;height:509px;">
                        <div class = "carousel-caption">
                           <h4>My Pic 3</h4>
                           <p> My Sports bike 3</p>
                        </div>
                    </div>

                    <div class = "item">
                        <img src="pics/9.jpg" style ="width:800px;height:509px;">
                        <div class = "carousel-caption">
                           <h4>My Pic 4</h4>
                           <p> My Sports bike 4</p>
                        </div>
                    </div>
                </div>
        ...
        <div class = "col-md-4">
          <div class = "thumbnail">
             ...
             <div class = "caption">
                   ...
                   <h4><a href="product.php">Sports Bike</a></h4>
                   <p>
                   Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam odio lacus, 
                    ...
                    Sed vitae augue diam. Praesent non odio eget neque blandit ornare. Duis semper justo purus, at finibus massa blandit.</p>
             </div>
           </div>
        </div>
